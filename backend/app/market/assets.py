...
# Company/issuer names for causal link matching.
# Maps symbol → tuple of lowercase name variants to search for in news titles.
# Used by orchestrator to upgrade causal_link_strength when the company name
# (not just the ticker) appears in the headline.
SYMBOL_COMPANY_NAMES: dict[str, tuple[str, ...]] = {
    ...
    "CAAP": ("corporacion america", "corporación america"),
    "VZ": ("verizon",),
